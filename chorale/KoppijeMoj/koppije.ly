  ...
  \score {
	...
	\new Voice = "melody" {
	  \relative {
		...
		{ r2 <c ees c'>4 }
	      ...
	      \repeat volta 2 {
		<bes d bes'>4 <bes d f> <bes d f> | <bes d f>2 <bes d f>4 | <bes ees g>2 <bes ees g>4 | <bes ees g> <bes ees g> <bes ees g> | <bes f' bes>2 <bes f' bes>4 | <bes f' bes>2 <bes ees aes>4 | <bes d g>2
	...
	<<
	  ...
	  \new Lyrics { \set associatedVoice = "melody"
			Me -- llo -- se -- mish te mit__te ma moi le  ve tem ash __ ti -- na Me
